...
<?php
// Query for CarID 1
$sql1 = $pdo->prepare("SELECT * FROM Cars WHERE CarID = :CarID");
$sql1->execute(['CarID' => 1]);
$res1 = $sql1->fetch(PDO::FETCH_ASSOC);

// Query for CarID 2
$sql2 = $pdo->prepare("SELECT * FROM Cars WHERE CarID = :CarID");
$sql2->execute(['CarID' => 2]);
$res2 = $sql2->fetch(PDO::FETCH_ASSOC);


// Query for CarID 2
$sql3 = $pdo->prepare("SELECT * FROM Cars WHERE CarID = :CarID");
$sql3->execute(['CarID' => 3]);
$res3 = $sql3->fetch(PDO::FETCH_ASSOC);

// Query for CarID 4
$sql4 = $pdo->prepare("SELECT * FROM Cars WHERE CarID = :CarID");
$sql4->execute(['CarID' => 4]);
            ...
            <div class="container">
                ...
                <div class="col-12 col-lg-10 col-xl-8 col-xxl-7">
                    ...
                    <div class="row gy-3 align-items-center">
                        <div class="col-md-4">
                        <a href="#!" class="bsb-hover-image d-block rounded overflow-hidden">
                            <img class="img-fluid author-avatar bsb-scale bsb-hover-scale-up" loading="lazy" src="<?php echo $res3["pic"]?>" alt="pic">
                        </a>
                        </div>
                        <div class="col-md-8">
                        <div class="card-body">
                            <h3 class="card-title mb-2">
                            <a class="card-link link-dark text-decoration-none" href="#!"><?php echo $res3["Name"]?></a>
                            </h3>
                            <p class="card-text mb-3"><?php echo $res3["Description"]?></p>
                        </div>
                        </div>
                    </div>
                    </div>
            ...
            <div class="container">
                ...
                <div class="col-12 col-lg-10 col-xl-8 col-xxl-7">
                    ...
                    <div class="row gy-3 align-items-center">
                        <div class="col-md-4">
                        <a href="#!" class="bsb-hover-image d-block rounded overflow-hidden">
                            <img class="img-fluid author-avatar bsb-scale bsb-hover-scale-up" loading="lazy" src="<?php echo $res4["pic"]?>" alt="pic">
                        </a>
                        </div>
                        <div class="col-md-8">
                        <div class="card-body">
                            <h3 class="card-title mb-2">
                            <a class="card-link link-dark text-decoration-none" href="#!"><?php echo $res4["Name"]?></a>
                            </h3>
                            <p class="card-text mb-3"><?php echo $res4["Description"]?></p>
                        </div>
                        </div>
                    </div>
                    </div>
